...
import './styles/AboutMe.css'; // Importing the CSS file for styling
import myPhoto from './assets/images/myPhoto.jpg'; // Importing the photo to be used
...
export default AboutMe; // Exporting the component for use in other parts of the application
